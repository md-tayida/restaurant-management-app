...
public interface OrderItemRepository extends JpaRepository<OrderItemEntity, Long> {
    List<OrderItemEntity> findByMenu_Category_NameAndStatus(String name, OrderItemStatusEnum status);
    List<OrderItemEntity> findAllByStatus(OrderItemStatusEnum status);
